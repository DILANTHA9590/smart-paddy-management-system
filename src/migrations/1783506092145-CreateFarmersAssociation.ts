...
export class CreateFarmersAssociation1783506092145 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`phone_number\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`date_of_birth\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`profile_image\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`organization_id\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`created_at\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`updated_at\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`phoneNumber\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD UNIQUE INDEX \`IDX_04889fbbf7dec355cc7f270583\` (\`phoneNumber\`)`);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`dateOfBirth\` date NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`createdBy\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`updatedBy\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`farmers\` CHANGE \`id\` \`id\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`id\` varchar(36) NOT NULL PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD UNIQUE INDEX \`IDX_2a96fbb368a1162f96481339be\` (\`nic\`)`);
        await queryRunner.query(`CREATE INDEX \`IDX_e65f209531c07fa50930397092\` ON \`farmers\` (\`district\`)`);
        await queryRunner.query(`CREATE INDEX \`IDX_5eba57e28d331c74d12a718f28\` ON \`farmers\` (\`province\`)`);
        await queryRunner.query(`CREATE INDEX \`IDX_07d54c2f215e64ae753e9147cd\` ON \`farmers\` (\`village\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP INDEX \`IDX_2a96fbb368a1162f96481339be\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`id\` int NOT NULL AUTO_INCREMENT`);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD PRIMARY KEY (\`id\`)`);
        await queryRunner.query(`ALTER TABLE \`farmers\` CHANGE \`id\` \`id\` int NOT NULL AUTO_INCREMENT`);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`updatedAt\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`createdAt\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`updatedBy\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`createdBy\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`dateOfBirth\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP INDEX \`IDX_04889fbbf7dec355cc7f270583\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` DROP COLUMN \`phoneNumber\``);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`organization_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`profile_image\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`date_of_birth\` date NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`farmers\` ADD \`phone_number\` varchar(255) NOT NULL`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_2a96fbb368a1162f96481339be\` ON \`farmers\` (\`nic\`)`);
    }
