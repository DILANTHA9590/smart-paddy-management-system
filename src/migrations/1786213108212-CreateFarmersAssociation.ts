...
export class CreateFarmersAssociation1786213108212 implements MigrationInterface {
    name = 'CreateFarmersAssociation1786213108212'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`farmers\` (\`id\` varchar(36) NOT NULL, \`nic\` varchar(255) NOT NULL, \`phoneNumber\` varchar(255) NOT NULL, \`address\` text NOT NULL, \`district\` varchar(255) NOT NULL, \`province\` varchar(255) NOT NULL, \`village\` varchar(255) NOT NULL, \`dateOfBirth\` date NOT NULL, \`gender\` enum ('Male', 'Female', 'Other') NOT NULL, \`createdBy\` varchar(255) NULL, \`updatedBy\` varchar(255) NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`user_id\` varchar(36) NULL, INDEX \`IDX_e65f209531c07fa50930397092\` (\`district\`), INDEX \`IDX_5eba57e28d331c74d12a718f28\` (\`province\`), INDEX \`IDX_07d54c2f215e64ae753e9147cd\` (\`village\`), UNIQUE INDEX \`IDX_2a96fbb368a1162f96481339be\` (\`nic\`), UNIQUE INDEX \`IDX_04889fbbf7dec355cc7f270583\` (\`phoneNumber\`), UNIQUE INDEX \`REL_f2598912e9b3fd889f6fecee93\` (\`user_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
