...
export class AddNewTable1775489924752 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`roles\` (\`id\` int NOT NULL AUTO_INCREMENT, \`role_name\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_ac35f51a0f17e3e1fe12112603\` (\`role_name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
